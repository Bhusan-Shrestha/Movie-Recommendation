...
movies_dict = pickle.load(open(r'D:\ML_Project\Movie_Recommendation\ML_Model\Movies_dict.pkl', 'rb'))
movies = pd.DataFrame(movies_dict)  # Convert dictionary to DataFrame

similarity = pickle.load(open(r'D:\ML_Project\Movie_Recommendation\ML_Model\similarity.pkl', 'rb'))
